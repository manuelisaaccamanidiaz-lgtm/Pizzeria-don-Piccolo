...
-- PIZZAS
-- ============================================
INSERT INTO pizza (nombre, descripcion, precio_venta, activa) VALUES
('Pizza Pepperoni', 'Pizza clásica con salsa de tomate, queso mozzarella y pepperoni', 18000.00, TRUE),
('Pizza Hawaiana', 'Pizza con salsa de tomate, queso mozzarella, jamón y piña', 19000.00, TRUE),
('Pizza Vegetariana', 'Pizza con salsa de tomate, queso mozzarella, champiñones, pimentón, aceitunas y cebolla', 20000.00, TRUE),
('Pizza Pollo BBQ', 'Pizza con salsa BBQ, queso mozzarella, pollo desmenuzado y cebolla', 22000.00, TRUE),
('Pizza Mixta', 'Pizza con salsa de tomate, queso mozzarella, pepperoni, jamón y champiñones', 21000.00, TRUE),
('Pizza Margarita', 'Pizza clásica con salsa de tomate, queso mozzarella fresca, orégano y aceite de oliva', 17000.00, TRUE);
...
-- PEDIDOS
-- ============================================
INSERT INTO pedido (id_cliente, metodo_pago, estado, total, notas) VALUES
(1, 'efectivo', 'entregado', 37000.00, 'Llamar antes de llegar'),
(2, 'tarjeta', 'entregado', 19000.00, NULL),
(3, 'efectivo', 'en_camino', 40000.00, 'Tocar el timbre 2 veces'),
(4, 'transferencia', 'en_preparacion', 22000.00, 'Sin cebolla por favor'),
(5, 'efectivo', 'pendiente', 38000.00, NULL),
(6, 'tarjeta', 'entregado', 17000.00, 'Extra de orégano'),
(1, 'efectivo', 'entregado', 21000.00, NULL),
(2, 'tarjeta', 'cancelado', 0.00, 'Cancelado por el cliente');
